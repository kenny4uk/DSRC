...
Sim.iternum0=10; % number of iterations for a fixed simulation scenario.
Sim.iternum1=10; % number of iterations for a fixed simulation scenario.
%Sim.node_set=[1:2:15];
%Sim.node_set=[1:10:100];
...
Phy.snr_set=[5 8 10 15 25 30 40];
...
Startrate_mode=[3]; % 0: random; >0: fixed data rate
...
for idx_start=1:sStart    
    ...
    Sim.n=cars(idx_node);                       % number of nodes in the BSS
