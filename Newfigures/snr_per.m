...
p(9,:) = polyfit(snr_ber_mode9(:,1), log(snr_ber_mode9(:,2)), exp_n);
p(10,:) = polyfit(snr_ber_mode10(:,1), log(snr_ber_mode10(:,2)), exp_n);
p(11,:) = polyfit(snr_ber_mode11(:,1), log(snr_ber_mode11(:,2)), exp_n);
p(12,:) = polyfit(snr_ber_mode12(:,1), log(snr_ber_mode12(:,2)), exp_n);
p(13,:) = polyfit(snr_ber_mode13(:,1), log(snr_ber_mode13(:,2)), exp_n);
for ii=1:sRate_mode
